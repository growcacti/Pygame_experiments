...
class Rect(object):
    ...
    def __getattr__(self, name):
        ...
        if name == "center":
            return v(self._x + self._w / 2.0, self._y + self._h / 2.0)
        if name == "midleft":
            return v(self._x, self._y + self._h / 2.0)
        if name == "midright":
            return v(self._x + self._w, self._y + self._h / 2.0)
        if name == "midtop":
            return v(self._x + self._w / 2.0, self._y)
        if name == "midbottom":
            return v(self._x + self._w / 2.0, self._y + self._h)
        if name == "size":
        ...
        raise AttributeError("type object 'rect' " "has no attribute '%s'" % name)
    ...
    def __setattr__(self, name, val):
        ...
        if name == "right":
            ...
            self._x = val - self._w / 2.0
        elif name == "centery":
            self._y = val - self._h / 2.0
        elif name == "center":
            self._x = val[0] - self._w / 2.0
            self._y = val[1] - self._h / 2.0
        elif name == "midtop":
            self._x = val[0] - self._w / 2.0
            self._y = val[1]
        elif name == "midleft":
    ...
    def contains(self, other):
        ...
        :returns: A `bool` indicating whether this rect is contained within
                  another.
        """
        return other.collide_point(self.topleft) and other.collide_point(
            self.bottomright
        )
    ...
    def collide_rect(self, other):
        ...
        :returns: A `bool` indicating whether this rect is contained within
                  another.
        """
        return self.clip(other).size != (0, 0) or other.clip(self).size != (0, 0)
