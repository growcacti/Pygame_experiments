...
class PauseScreen(tools._State):
    ...
    def make_labels(self):
        ...
        delay = 750
        space = 0
        colors = [(0, 227, 255), (236, 230, 255), (255, 120, 255), (236, 230, 255)]
        self.label1 = StainedGlass(
            (cx, (cy - space) - dist),
            prepare.GFX["word-pause"],
            prepare.GFX["cover-pause"],
            colors,
            80,
            1000,
            self.labels,
