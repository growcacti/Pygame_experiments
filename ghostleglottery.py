    ...
    for currentRow in range(len(legs)):
        ...
        for currentPole in range(len(playerNames)):
            ...
            if (currentPole == poleWithLegOnCurrentRow) and (currentPole == pathPole):
                ...
                print("V", end="")
                print(">" * LEG_WIDTH, end="")
            elif (currentPole == poleWithLegOnCurrentRow) and (
                poleToTheRightOfCurrentPole == pathPole
            ):
                # 'V<<<<<<<<<<'
                print("V", end="")
                print("<" * LEG_WIDTH, end="")
            ...
            elif (poleToTheLeftOfCurrentPole == poleWithLegOnCurrentRow) and (
                currentPole == pathPole or poleToTheLeftOfCurrentPole == pathPole
            ):
