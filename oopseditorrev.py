        ...
        for column in range(self.columns):
            for row in range(self.rows):
                ...
                screen.blit(
                    tile.image,
                    (
                        (TILE_WIDTH * column) + self.graph_shift_x,
                        (TILE_HEIGHT * row) + self.graph_shift_y,
                    ),
                )
...
class Tile(Entity):
    def __init__(
        self, width=None, height=None, solid=None, color=None, loadedimage=None
    ):
