...
try:
    ...
    print(
        """This program requires the bext module, which you can
...
DEFAULT_SCALEY = (
    HEIGHT - 4
) // 4  # Text cells are twice as tall as they are wide, so set scaley accordingly.
...
def transformPoint(
    ...
    return (
        int(point1[0] * scalex + translatex),
